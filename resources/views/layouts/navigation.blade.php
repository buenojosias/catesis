        ...
        <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div class="flex-1 px-3 bg-white divide-y space-y-1">
                ...
                <div class="space-y-2 pt-2">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" icon="user">Dashboard</x-nav-link>
                </div>
            </div>
        </div>
    </div>
...
class="bg-gray-900 lg:hidden opacity-50 fixed inset-0 z-10"></div>
